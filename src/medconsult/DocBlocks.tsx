...
import { STD_DOC_BLOCKS, packsMatchingCode, useTemplates } from "./data/templates";
        ...
        createPortal(
          ...
          >
            <div className="min-h-0 flex-1 overflow-auto p-2">
              ...
              {visitPacks.length === 0 && <p className="px-1 py-2 text-xs text-mute">Справочник → Шаблоны → наборы</p>}
            </div>
          </div>,
          document.body,
        )}
