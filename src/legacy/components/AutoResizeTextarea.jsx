...
export default function AutoResizeTextarea({ value, onChange, className = '', minRows = 2, textareaRef, compact = false, ...rest }) {
  ...
  return (
    <textarea
      ...
      onInput={resize}
      rows={minRows}
      style={compact ? { overflow: 'hidden', resize: 'none' } : { overflow: 'auto', resize: 'vertical' }}
      {...rest}
    />
  )
}
